 ...
 * </p>
 * <ul>
 *   <li>{@link at.bitandart.zoubek.mervin.testmodel.impl.AvatarImpl#getUri <em>Uri</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AvatarImpl extends MinimalEObjectImpl.Container implements Avatar {
	...
	protected EClass eStaticClass() {
		return TestModelPackage.Literals.AVATAR;
	}
	...
	public void setUri(String newUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestModelPackage.AVATAR__URI, oldUri, uri));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestModelPackage.AVATAR__URI:
				return getUri();
		}
