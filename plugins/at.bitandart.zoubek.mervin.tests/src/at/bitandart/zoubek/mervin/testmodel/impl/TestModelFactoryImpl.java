...
public class TestModelFactoryImpl extends EFactoryImpl implements TestModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TestModelPackage.TODO_LIST: return createTodoList();
			case TestModelPackage.TEXT_ENTRY: return createTextEntry();
			case TestModelPackage.USER: return createUser();
			case TestModelPackage.AVATAR: return createAvatar();
			default:
	...
	public TextEntry createTextEntry() {
		TextEntryImpl textEntry = new TextEntryImpl();
		return textEntry;
	}
	...
	public Avatar createAvatar() {
		AvatarImpl avatar = new AvatarImpl();
		return avatar;
	}
