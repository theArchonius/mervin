...
/**
 * Handles hide/show request for comment overlays.
 * 
 * @author Florian Zoubek
 *
 */
public class ToggleCommentOverlays {
	...
	public void execute(MHandledToolItem item, ModelReview modelReview, Diagram diagram, EditDomain editDomain,
		...
		visibilityState.setVisibility(IOverlayTypeDescriptor.TYPE_DESCRIPTOR_COMMENTS, item.isSelected());
