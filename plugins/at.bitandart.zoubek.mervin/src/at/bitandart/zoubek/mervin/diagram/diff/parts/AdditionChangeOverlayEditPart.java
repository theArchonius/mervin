 ...
 * represent an addition change.
 * 
 * @author Florian Zoubek
 *
 */
public class AdditionChangeOverlayEditPart extends ShapeNodeEditPart implements IOverlayEditPart {

	public AdditionChangeOverlayEditPart(View view) {
		super(view);
	}
