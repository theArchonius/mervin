 ...
 * represent an deletion change.
 * 
 * @author Florian Zoubek
 *
 */
public class DeletionChangeOverlayEditPart extends ShapeNodeEditPart implements IOverlayEditPart {

	public DeletionChangeOverlayEditPart(View view) {
		super(view);
	}
