 ...
 * <ul>
 * <li>
 * {@link at.bitandart.zoubek.mervin.model.modelreview.impl.DifferenceOverlayImpl#getLinkedView
 * <em>Linked View</em>}</li>
 * <li>
 * {@link at.bitandart.zoubek.mervin.model.modelreview.impl.DifferenceOverlayImpl#getDifferences
 * <em>Differences</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DifferenceOverlayImpl extends MinimalEObjectImpl.Container implements DifferenceOverlay {
	/**
	 ...
	 * @generated
	 */
	protected DifferenceOverlayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModelReviewPackage.Literals.DIFFERENCE_OVERLAY;
	}
			...
			if (linkedView != oldLinkedView) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModelReviewPackage.DIFFERENCE_OVERLAY__LINKED_VIEW, oldLinkedView, linkedView));
			}
		}
		return linkedView;
	}
	...
	public void setLinkedView(View newLinkedView) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelReviewPackage.DIFFERENCE_OVERLAY__LINKED_VIEW,
					oldLinkedView, linkedView));
	}
	...
	public EList<Difference> getDifferences() {
		if (differences == null) {
			differences = new EObjectContainmentEList<Difference>(Difference.class, this,
					ModelReviewPackage.DIFFERENCE_OVERLAY__DIFFERENCES);
		}
		return differences;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ModelReviewPackage.DIFFERENCE_OVERLAY__DIFFERENCES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModelReviewPackage.DIFFERENCE_OVERLAY__LINKED_VIEW:
			if (resolve)
